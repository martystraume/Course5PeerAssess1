...
##### 4. If a SHA-1 was submitted along with the GitHub URL, does the SHA-1 correspond to a specific commit in the repository?
...
##### 1. Does the submission show code for reading in the dataset and/or processing the data? 

0 points: There is no code presented for reading in the dataset  
1 point: There is code presented for reading in the dataset

##### 2. Does the submission contain a histogram of the total number of steps taken each day?
...
##### 3. Are both the mean and median number of steps taken each day reported?
...
##### 4. Is there a time series plot of the average number of steps taken (averaged across all days) versus the 5-minute intervals?
...
##### 5. Does the report give the 5-minute interval that, on average, contains the maximum number of steps?
...
##### 6. Does the report describe and show with code a strategy for imputing missing data?
...
##### 7. Does the report contain a histogram of the total number of steps taken each day after missing values were imputed?
...
##### 8. Does the report contain a panel plot comparing the average number of steps taken per 5-minute interval across weekdays and weekends?

0 points: No, there is no panel plot  
1 point: Yes, there is a panel plot

##### 9. Does the report show all of the R code needed to reproduce the results (numbers, plots, etc.) in the report?
